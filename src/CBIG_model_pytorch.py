...
def stacking(y_pred_k, y_pred_test, y_k, alpha=[0.00001, 0.0001, 0.001, 0.004, 0.007, 0.01, 0.04, 0.07, 0.1, 0.4, 0.7, 1, 1.5, 2, 2.5, 3, 3.5, 4, 5, 10, 15, 20], n_jobs=1):
    '''perform stacking
    ...
    clf = GridSearchCV(krr, parameters, cv=cv, n_jobs=n_jobs)
